...
В рабочем каталоге приложения **ИМП** расположен файл :bolditalic:`rec.xlsm`, являющийся заготовкой протокола,
...
и результатах измерений найденных им датчиков.
...
Здесь же содержится дополнительная информация по настройке записи для макроса и приведены рабочие примеры.
