...
#define DEF_VERSION_MINOR   5
#define DEF_VERSION_PATCH   6
#define DEF_VERSION_TEST    2


#define FILE_VERSION_MAIN DEF_VERSION_MAJOR,DEF_VERSION_MINOR,DEF_VERSION_PATCH,1

#define FILE_VERSION_STR "21. 5. 6. 2\0"
...
#define ANOTHER_PRODUCT_STR "UV 21.5.6.2\0"
